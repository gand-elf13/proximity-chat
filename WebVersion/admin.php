...
<html>
	...
	<body>
		...
		<form class="input-form" method="post" name="message" action="">
    		...
    		<input name="latitude" type="text" id="latitudetemp" value= "" />
	        <input name="longitude" type="text" id="longitudetemp" value= "" />
            ...
            if (isset($lat) AND isset($long) AND !empty($lat) AND !empty($long))
            {
                while($msg = $allmsg->fetch())
                {
                    ...
                    <span class="text-message">
                        <?php echo " " ,$msg['message'],$factor?>
                    </span>
                    
                    <span class="distance">
                        <?php echo " (",$distance," ",$lat," ",$long,")"?>
                    </span><br/>
                    <?php
